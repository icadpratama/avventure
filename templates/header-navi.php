		...
		<div class="columns_wrap columns_fluid">
			<div class="sc_layouts_column sc_layouts_column_align_left sc_layouts_column_icons_position_left sc_layouts_column_fluid column-1_4">
				...
				<div class="sc_layouts_item">
					<?php
					// Main menu
					$avventure_menu_main = avventure_get_nav_menu(
						array(
							'location' => 'menu_main',
					...
					if ( avventure_get_theme_setting( 'autoselect_menu' ) && empty( $avventure_menu_main ) ) {
						$avventure_menu_main = avventure_get_nav_menu(
							array(
								'class' => 'sc_layouts_menu sc_layouts_menu_default sc_layouts_hide_on_mobile',
							)
					...
					avventure_show_layout( $avventure_menu_main );
					// Mobile menu button
					?>
				...
				if ( avventure_exists_trx_addons() ) {
					...
					<div class="sc_layouts_item">
						...
						do_action( 'avventure_action_search', 'fullscreen', 'header_search', false );
						?>
					</div>
					<?php
				}
