...
if ( ! function_exists( 'avventure_woocommerce_get_css' ) ) {
	add_filter( 'avventure_filter_get_css', 'avventure_woocommerce_get_css', 10, 2 );
	function avventure_woocommerce_get_css( $css, $args ) {
...
/* Shop mode selector */
.avventure_shop_mode_buttons a {
	color: {$colors['text_dark']};
}
.avventure_shop_mode_buttons a:hover {
	color: {$colors['text_hover']};
}
.shop_mode_thumbs .avventure_shop_mode_buttons a.woocommerce_thumbs,
...
.woocommerce ul.products li.product .post_item:hover .post_featured{
...
ul.products li.product .post_featured.hover_shop .icons a {
	color: {$colors['text_dark']};
	border-color: {$colors['text_link']} !important;
	background-color: {$colors['text_link']};
}
ul.products li.product .post_featured.hover_shop .icons a:hover {
	color: {$colors['inverse_link']};
