...
if ( ! function_exists( 'avventure_tribe_events_get_css' ) ) {
	add_filter( 'avventure_filter_get_css', 'avventure_tribe_events_get_css', 10, 2 );
	function avventure_tribe_events_get_css( $css, $args ) {
