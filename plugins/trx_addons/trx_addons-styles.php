...
if ( ! function_exists( 'avventure_trx_addons_add_theme_vars' ) ) {
	add_filter( 'avventure_filter_add_theme_vars', 'avventure_trx_addons_add_theme_vars', 10, 2 );
	function avventure_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'avventure_trx_addons_get_css' ) ) {
	add_filter( 'avventure_filter_get_css', 'avventure_trx_addons_get_css', 10, 2 );
	function avventure_trx_addons_get_css( $css, $args ) {
...
.post_format_gallery  .slider_container .slider_pagination_wrap .swiper-pagination-bullet,
.post_format_gallery  .slider_outer .slider_pagination_wrap .swiper-pagination-bullet,
.post_format_gallery  .swiper-pagination-custom .swiper-pagination-button,
.sc_testimonials .sc_slider_controls.slider_pagination_style_bullets .slider_pagination_bullet,
...
.widget_slider .sc_slider_controls.slider_pagination_style_bullets .slider_pagination_bullet,
.widget_slider .slider_container .slider_pagination_wrap .swiper-pagination-bullet,
.widget_slider .slider_outer .slider_pagination_wrap .swiper-pagination-bullet,
.widget_slider .swiper-pagination-custom .swiper-pagination-button {
...
.sc_layouts_menu_nav > li > ul:before {
    border-bottom-color: {$colors['extra_bg_color']};
}
...
.widget_display_search form input,
#bbpress-forums #bbp-search-form input,
.widget_search form input:hover,
.woocommerce.widget_product_search form input:hover,
.widget_display_search form input:hover,
#bbpress-forums #bbp-search-form input:hover{
	color: {$colors['input_text']};
	border-color: {$colors['bd_color']};
	background-color: {$colors['alter_bg_color']};
}
...
.wp-widget-recent-posts li .post-date{
	color: {$colors['text_link']};
}
...
.sc_blogger_item.format-video .post_featured.with_thumb .post_video_hover:hover,
...
.sc_price_item .sc_price_item_description p + p,
.sc_price_item .sc_price_item_details p + p{
	border-color: {$colors['bd_color']};
}
...
.sc_blogger_plain .post_meta.post_meta_in_featured a:hover,
.post_meta.post_meta_in_featured a {
	color: {$colors['text_dark']} !important;
	background-color: {$colors['alter_bg_color']};
}
.sc_blogger_plain .post_meta.post_meta_in_featured a,
.post_meta.post_meta_in_featured a:hover  {
	color: {$colors['inverse_link']} !important;
	background-color: {$colors['text_link2']};
}
.post_featured_wrap .post_meta.post_meta_in_featured a,
.post_featured .post_meta.post_meta_in_featured a {
	background-color: {$colors['bg_color']};
}
.post_featured_wrap .post_meta.post_meta_in_featured a:hover,
.post_featured .post_meta.post_meta_in_featured a:hover  {
	background-color: {$colors['text_link2']};
} 
...
.esg-filters div.esg-navigationbutton:after, .woocommerce nav.woocommerce-pagination ul li a:after, .woocommerce nav.woocommerce-pagination ul li span.current:after, .page_links > span:not(.page_links_title):after, .page_links > a:after, .comments_pagination .page-numbers:after, .nav-links .page-numbers:after{
	color: {$colors['text_dark']};
}
...
.wpim-marker .wpim-marker__icon:hover:before {
	color: {$colors['text_dark']};
}

.sc_blogger .post_counters_item,
.sc_blogger .post_counters_item:after,
.sc_blogger .post_counters_item:before{
	color: {$colors['text_link2']};
}
.sc_blogger .post_counters_item:hover,
.sc_blogger .post_counters_item:hover:after,
.sc_blogger .post_counters_item:hover:before{
	color: {$colors['text_hover2']};
}
...
.accordion-light-bg .elementor-accordion .elementor-tab-title,
.accordion-light-bg .elementor-accordion .elementor-accordion-item,
.accordion-light-bg .elementor-accordion .elementor-tab-content{
    background-color: {$colors['bg_color']};
    border-color: {$colors['bg_color']};
}
.elementor-accordion .elementor-tab-title,
...
[id*=give-form] .give_warning:before{
    background-color: {$colors['text_link']};
}
...
.page_wrap .sc_button_side,
.page_wrap .sc_button_side:after {
    color: {$colors['text_link2']};
}
.sc_button.sc_button_simple:hover,
.sc_button.sc_button_simple:hover:after,
.page_wrap .sc_button_side:hover,
.page_wrap .sc_button_side:hover:after {
    color: {$colors['text_link']};
}
...
.sc_action_event .sc_action_item_event.with_image .sc_action_item_info{
    color: {$colors['text_link2']};
}
.sc_action_event .sc_action_item_event.with_image .sc_action_item_subtitle span{
    color: {$colors['inverse_text']};
    background-color: {$colors['text_link2']};
}

.minimal-dark .esg-loadmore-wrapper .esg-navigationbutton {
    color: {$colors['text_link2']} !important;
}

.minimal-dark .esg-loadmore-wrapper .esg-navigationbutton:hover {
    color: {$colors['text_dark']} !important;
}
...
.trx_addons_scroll_to_top.trx_addons_icon-up:hover {
    color: {$colors['text_link']};
}
