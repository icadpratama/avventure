== BaseKit ==
Version: 1.0
Copyright: 2018, ThemeREX
WordPress version: required at least 4.5, tested up to 4.9
...
All available options can be used from 'Appearance->Customize' or from 'Appearance->Theme Options'.
For the full realization of their capabilities, the theme requires a satellite plugin 'ThemeREX Addons'.
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About BaseKit'.
Please install and activate it before starting to use the theme BaseKit.
Also the theme supports many popular plugins such as 'Revolution Slider', 'Visual Composer', 'WooCommerce'
and many more.
...
2) Icons (css/font-icons/*.*)
   The icon set used in BaseKit is Fontello.
